// Aplica db/migrations/0023_woozy_satana.sql direto via client,
// pulando drizzle-kit migrate (quebrado — ver memória do projeto).
// Uso: node --env-file=.env.local scripts/apply-migration-0023.mjs [--prod]
...
const sqlPath = new URL('../db/migrations/0023_woozy_satana.sql', import.meta.url);
...
const cols = await sql`
  ...
  where table_name in ('voting_rounds', 'voting_guest_invites', 'voting_guest_ballots')
