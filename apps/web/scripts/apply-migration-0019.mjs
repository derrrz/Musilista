// Aplica db/migrations/0019_wise_next_avengers.sql direto via client,
// pulando drizzle-kit migrate (quebrado — ver memória do projeto).
// Uso: node --env-file=.env.local scripts/apply-migration-0019.mjs [--prod]
...
const sqlPath = new URL('../db/migrations/0019_wise_next_avengers.sql', import.meta.url);
...
const cols = await sql`
  ...
  where table_name = 'ai_usage_monthly'
