// Aplica db/migrations/0026_wandering_kinsey_walden.sql direto via client,
// pulando drizzle-kit migrate (quebrado — ver memória do projeto).
// Uso: node --env-file=.env.local scripts/apply-migration-0026.mjs [--prod]
...
const sqlPath = new URL('../db/migrations/0026_wandering_kinsey_walden.sql', import.meta.url);
...
const cols = await sql`
  select column_name from information_schema.columns where table_name = 'song_previews' order by column_name
`;
