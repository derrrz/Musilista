// Aplica db/migrations/0025_supreme_piledriver.sql direto via client,
// pulando drizzle-kit migrate (quebrado — ver memória do projeto).
// Uso: node --env-file=.env.local scripts/apply-migration-0025.mjs [--prod]
...
const sqlPath = new URL('../db/migrations/0025_supreme_piledriver.sql', import.meta.url);
...
const cols = await sql`
  ...
  where table_name = 'song_previews'
